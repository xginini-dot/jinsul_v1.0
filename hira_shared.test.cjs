...
test('shared fee request includes same-origin access session',()=>{assert.match(html,/fetch\(new URL\('hira-prices\.json',location\.href\),\{cache:'no-store',credentials:'same-origin'/)});
